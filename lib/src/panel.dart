...
class SlidingUpPanel extends StatefulWidget {
  ...
  /// [panel] will be used.
  final Widget Function(BuildContext context, ScrollController sc, Animation<double> position)? panelBuilder;
  ...
  final void Function(Animation<double> animation)? onPanelSlide;
  ...
  /// the panel should slide. Defaults to [SlideDirection.up]. If set to [SlideDirection.down], the panel attaches
...
class _SlidingUpPanelState extends State<SlidingUpPanel> with SingleTickerProviderStateMixin {
  ...
  late _ExtendedPanelState _lastPanelState;

  late double _acPrevValue;
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                          ...
                          child: Container(
                            ...
                            width: constraints.maxWidth,
                            child: widget.panel != null ? widget.panel : widget.panelBuilder!(context, _sc, _ac),
                          )),
